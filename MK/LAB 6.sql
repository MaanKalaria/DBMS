...
SELECT LOWER('MAAN'),UPPER('maan')
--3. Display first three characters of your name.
SELECT SUBSTRING('MAAN',1,3)
--4. Display 3rd to 10th character of your name.
SELECT SUBSTRING('MAAN KALARIA',3,10)
--5. Write a query to convert ‘abc123efg’ to ‘abcXYZefg’ & ‘abcabcabc’ to ‘ab5ab5ab5’ using REPLACE.
SELECT REPLACE('abc123efg','123','XYZ')
SELECT REPLACE('ab5ab5ab5','C',5)
--6. Write a query to display ASCII code for ‘a’,’A’,’z’,’Z’, 0, 9.
SELECT ASCII('a'),ASCII('A'),ASCII('a'),ASCII('z'),ASCII('Z'),ASCII(0),ASCII('9')
...
SELECT CAST('1234.56' AS DECIMAL(6,2)), CONVERT(DECIMAL(7,2),'1234.56')
--12. Write a query to convert a float 10.58 to integer (Use cast and convert function).
SELECT CAST(10.58 AS INT), CONVERT(INT,10.58)
--13. Put 10 space before your name using function.
SELECT SPACE(10) + 'MAAN'
--14. Combine two strings using + sign as well as CONCAT ().
SELECT 'MAAN' + 'KALARIA', CONCAT('MAAN' , 'KALARIA')
--15. Find reverse of “Darshan”.
SELECT REVERSE('DARSHAN')
--16. Repeat your name 3 times
SELECT REPLICATE('MAAN ',3)
...
SELECT DATEDIFF(YEAR,'2005-06-14',GETDATE())